                                        ...
                                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div className="z-10 sm:col-span-6">
                                                ...
                                                <ul className='mt-2 flex flex-wrap'>
                                                    <li className='mt-2'>
                                                        <a class="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-custom_blue focus-visible:text-custom_blue" href="https://developer.apple.com/documentation/musickitjs" target="_blank" rel="noreferrer">
