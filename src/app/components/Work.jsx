...
function Work() {
    ...
    return (
        <div className='h-screen grid grid-cols-1 lg:grid-cols-2 px-[5rem] container mx-auto'>
            ...
            <div>
                <p className='text-green text-sm'>WHERE I'VE WORKED</p>
                <h1 className='text-lightest_slate text-[3rem] font-semibold'>I'm using top leading design methods.</h1>
                <p className=' mt-2'>I specialize in helping early stage startups validate their riskiest assumptions using leading design methods.</p>
                ...
                <div className="flex mt-5">
                    <button onClick={
                        ...
                        className={
                            `transition-all text-sm duration-700 hover:text-teal-400 hover:bg-teal-400/10 px-[1rem] py-[0.5rem] border-b-[2px]  ${
                                step === 1 ? 'text-teal-400 border-teal-400 bg-teal-400/10' : 'border-slate-600'
                            }`
                    }>Resolute B2B</button>
                    <button onClick={
                            () => {
                        ...
                        className={
                            `transition-all text-sm duration-500 hover:text-teal-400 hover:bg-teal-400/10 px-[1rem] py-[0.5rem] border-b-[2px] ${
                                step === 2 ? 'text-teal-400 border-teal-400 bg-teal-400/10' : 'border-gray-600'
                            }`
                    }>Cloudkakshaa</button>
                </div>
                <div>
                        ...
                        <div className='mt-5'>
                            <ol className="group/list">
                                ...
                                <li className={
                                    ...
                                    <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                        <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></div>
                                        <header className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2" aria-label="July to December 2017">August 2021 - March 2022</header>
                                        <div className="z-10 sm:col-span-6">
                                            <h3 className="font-medium leading-snug text-slate-200">
                                                <div>
                                                    <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base" href="https://www.cloudkakshaa.org/" target="_blank" rel="noreferrer" aria-label="UI Engineer Co-op at Apple">
                                                        <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                                        <span>CloudKakshaa
                            ...
                            <div className="mt-12">
                                <a className="inline-flex items-center leading-tight font-semibold text-slate-200 group" aria-label="View Full Resume" href="/resume.pdf">
                                    <span>
                                        <span className="border-b border-transparent pb-px transition group-hover:border-teal-300 motion-reduce:transition-none">View Full
