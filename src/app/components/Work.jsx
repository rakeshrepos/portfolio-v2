...
function Work() {
    ...
    return (
        <div className='min-h-screen bg-[#000] py-[1rem]'>
                                    ...
                                    <li className={
                                        ...
                                        <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                                            ...
                                            <div className="z-10 sm:col-span-6">
                                                <h3 className="font-medium leading-snug text-slate-200">
                                                    <div>
                                                        <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-custom_blue focus-visible:text-custom_blue  group/link text-base" href="https://www.teachforindia.org/" target="_blank" rel="noreferrer" aria-label="UI Engineer Co-op at Apple">
                                                            <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                                                            <span>Lead Developer - TeachForIndia
                                                ...
                                                <p className="mt-2 text-sm leading-normal">As the lead developer (internship) for Teach For India's CloudKaksha, I spearheaded the technical aspects of the edtech startup. My role involved overseeing platform development, designing robust systems, managing a team of developers, and ensuring seamless delivery of interactive educational content. My contributions played a crucial role in providing equitable education and empowering students from underserved communities.</p>
                                                <ul className='mt-2 flex flex-wrap'>
                                                    <li className='mt-2'>
                                                        <a className="relative mt-2 inline-flex items-center text-sm font-medium text-slate-300 hover:text-custom_blue focus-visible:text-custom_blue" href="https://developer.apple.com/documentation/musickitjs" target="_blank" rel="noreferrer">
